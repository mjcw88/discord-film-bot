...
// Main async function that fetches a TV show's recommendations
async function tvrecommendations(interaction, REGION, TIMEOUT, MAX_DIGITS, MESSAGES) {
    ...
    try {
        ...
        const recommendationsURL = `${BASE_URL}/tv/${tvId}/recommendations?api_key=${KEY}&region=${REGION}&page=${page}`;
    ...
    function getRecommendation(show) {
...
module.exports = { tvrecommendations };